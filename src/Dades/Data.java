...
public class Data {
    ...
    /**
     * Constructor que rep la data per paràmetre Ha de validar que la data és
     * correcta. Si rep una data incorrecta inicialitza la instància amb la data
     * de referència.
     *
     * @param dia
     * @param mes
    ...
    /**
     * Setter conjunt per a poder validar la correctesa de la data rebuda. Només
     * es fa la modificació de la data si que es rep per paràmetre és correcte.
     *
     * @param dia
     * @param mes
     * @param any
    ...
    /**
     * Mètode que calcula quants dies falten per arribar des de la data actual a
     * la que rebem per paràmetre
     *
     * @param data - valor de data a la que calcular el número de dies que
     * falten
     * @return si la data que es rep per paràmetre és superior o igual a la data
     * de la instància sobre la que es crida el mètode es retorna el número de
    ...
    /**
     * Mètode per comprova si la data actual és inferior a la passada per
     * paràmetre
     *
     * @param nova
     * @return
