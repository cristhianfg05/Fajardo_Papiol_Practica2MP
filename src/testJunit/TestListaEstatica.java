...
class TestListaEstatica {
	...
	private static ListaRecursoEstatica instance = new ListaRecursoEstatica();
	...
	void testMesConsultat() {
		...
		for (int i = 0; i < 500; i++) {
			instance.getListaRecurso()[3].afegirVisita(new Visita(1, "Cristhian", new Data(1, 1, 2000), Time.valueOf("10:05:32")));
		}
	...
	void testLlistaRecursosConsultatsAlies() {
		...
		Recurso listaEsperada[] = { new Recurso(1, "Video MP"),
				new Recurso(13, "Programacion examen"), 
